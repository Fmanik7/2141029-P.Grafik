...
const angleInRadians = Math.PI / 4; // 45 derajat

// Matriks rotasi 2D untuk merotasi titik sebesar angleInRadians
...
// Mengalikan matriks rotasi dengan setiap titik untuk memutar persegi ke kiri sebesar 45 derajat
function rotatePoints(points, angle) {
  ...
  for (let i = 0; i < points.length; i += 2) {
    ...
    rotatedPoints.push(
      ...
      rotation[2] * x + rotation[3] * y
    );
  }
  return rotatedPoints;
}

// Persegi awal yang sudah diputar ke kiri sebesar 45 derajat
const initialPersegiPanjang = rotatePoints([
  -0.1, 0.35,
  -0.1, -0.35,
  0.1, 0.35,
  -0.1, -0.35,
...
function animate() {
  ...
  function drawFrame() {
    ...
    const updatedPersegiPanjang = rotatePoints([
