...
function drawBlades() {
    ...
    for (var i = 0; i < numBlades; i++) {
        ...
        var p1 = [Math.cos(angle) * 0.5 + center[0], Math.sin(angle) * 0.5 + center[1]];
        var p2 = [Math.cos(angle + angleIncrement) * 0.5 + center[0], Math.sin(angle + angleIncrement) * 0.5 + center[1]];
